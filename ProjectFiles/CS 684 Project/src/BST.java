...
public class BST {
	...
	/*
	 * Simple Randomized closest pair problem using BST. Time complexity is O(n*log n)
	 */
	...
	public static CP findCP(List<Point> points) {
		...
		System.out.println("Iteration counter in BST is : " + counter );
		return cP;
	}

	private static Map<Box,List<Point>> BuildGrid(List<Point> points, Double dist) {		//function for Building new grid.
		Map<Box,List<Point>> grid = new TreeMap<Box, List<Point>>();
